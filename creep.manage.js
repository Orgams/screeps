...
let fonc_manage_creep = function(room) {
    ...
    configs.push(new Config('transferer', 1,        1,   1,       2,   oneWorkTreeCarry, "#00ff00", "local", false));
    configs.push(new Config('janitor'   , 2,        0,   0,       0,   oneWorkTreeCarry, "#00ffff", "local", false));
    configs.push(new Config('miner'     , 3,        0,   0,       0,   fullWork,         "#ff00ff", "autre", false));
    configs.push(new Config('builder'   , 4,        1,   1,       2,   carryWork,        "#ff0000", "local", false));
